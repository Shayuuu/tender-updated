            ...
            {tableData.length === 0 ? (
              ...
              <table className="task-summary-table">
                <thead>
                  <tr>
                    <th>Section</th>
                    {tab === 'project' && <th>Project Name</th>}
                    {tab === 'employee' && <th>Employee Name</th>}
                    <th>Pending Tasks</th>
                ...
                <tbody>
                  {tableData.map((row, index) => (
                    <tr key={index}>
                      <td>{row.section}</td>
                      {tab === 'project' && <td>{row.projectName}</td>}
                      {tab === 'employee' && <td>{row.employeeName}</td>}
                      <td>{row.pending}</td>
