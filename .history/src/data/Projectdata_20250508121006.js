const projectData = [
  {
    ...
    forms: {
      ...
      psdBgFdrNo: "PSD67890",
      asdBgFdrIssuedInFavorOf: "State Highway Authority",
      psdBgFdrReturnDate: "2024-05-01",
      formOfPsd: "FDR",
      psdBgFdrValidity: "2024-07-01",
      psdBgFdrStatus: "Not Returned",
      psdBgFdrIssuedInFavorOf: "State Highway Authority",
  ...
  },
  {
    ...
    dates: [
      { completionNo: 1, date: "2024-09-15" }
    ],
    account: {
      summary: {
        cumulativeValueOfBills: "₹80,00,000",
        balanceValueOfContract: "₹40,00,000",
        revisedValueFromVariation: "₹5,00,000"
      },
      bills: [
        {
          raNumber: "RA1",
          date: "2023-07-01",
          billAmount: "₹25,00,000",
          cumulativeAmount: "₹25,00,000",
          workBreakdownStructure: "Foundation and structure"
        },
        {
          raNumber: "RA2",
          date: "2023-11-01",
          billAmount: "₹30,00,000",
          cumulativeAmount: "₹55,00,000",
          workBreakdownStructure: "Interior finishing"
        },
        {
          raNumber: "RA3",
          date: "2024-03-01",
          billAmount: "₹25,00,000",
          cumulativeAmount: "₹80,00,000",
          workBreakdownStructure: "Amenities installation"
        }
      ]
    },
    expenses: [],
  ...
  },
  {
    ...
    dates: [
      { completionNo: 1, date: "2025-04-10" },
      { completionNo: 2, date: "2025-04-20" }
    ],
    account: {
      summary: {
        cumulativeValueOfBills: "₹1,20,00,000",
        balanceValueOfContract: "₹80,00,000",
        revisedValueFromVariation: "₹10,00,000"
      },
      bills: [
        {
          raNumber: "RA1",
          date: "2023-08-01",
          billAmount: "₹40,00,000",
          cumulativeAmount: "₹40,00,000",
          workBreakdownStructure: "Demolition and piling"
        },
        {
          raNumber: "RA2",
          date: "2024-01-01",
          billAmount: "₹50,00,000",
          cumulativeAmount: "₹90,00,000",
          workBreakdownStructure: "Beam installation"
        },
        {
          raNumber: "RA3",
          date: "2024-06-01",
          billAmount: "₹30,00,000",
          cumulativeAmount: "₹1,20,00,000",
          workBreakdownStructure: "Deck construction"
        }
      ]
    },
    expenses: [],
