...
const Extension = () => {
  ...
  useEffect(() => {
    ...
    if (data && data.extensionDates) {
      ...
      // Initialize as empty array if no extensionDates
      setExtensionDates([])
    }
  }, [id])
  ...
  const handleSaveAdd = () => {
    if (newDate) {
      ...
      if (bidderIndex !== -1) {
        ...
        const newBidder = { id: parseInt(id), extensionDates: updatedDates }
        localData.push(newBidder)
      }
        ...
        <div className="extension-content">
          ...
          <div className="extension-list-container">
            ...
            <div className="extension-list">
              {extensionDates.length === 0 && !isAdding && (
                <div className="extension-empty">
                  No extension dates available.
                </div>
              )}
