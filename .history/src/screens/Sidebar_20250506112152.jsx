...
const Sidebar = ({ currentRoute }) => {
  const [isSidebarPinned, setIsSidebarPinned] = useState(false) // Pinned by default
  ...
  return (
    <div className="sidebar-container">
      ...
      <aside
        ...
        onMouseEnter={() => !isSidebarPinned && setIsSidebarPinned(true)}
        onMouseLeave={() => !isSidebarPinned && setIsSidebarPinned(false)}
      >
