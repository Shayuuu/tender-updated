...
const Sidebar = ({ currentRoute }) => {
  ...
  const sectionIdMatch = location.pathname.match(/\/(bidders|extension-dates|bidder-details|milestone-tracker|forms|dates|running-account|expenses|variations|notes)\/(\d+)/)
  ...
  const projectSubsectionRoutes = [
    ...
    { path: '/running-account/:id', exact: true },
          ...
          <div className="sidebar-project-section">
            ...
            {(isSidebarPinned || isSidebarExpanded) && isProjectSubsectionOpen && (
              <div className="sidebar-project-subsection">
                ...
                <Link
                  to={location.pathname.match(/^\/running-account\/[^/]+$/) ? location.pathname : `/running-account/${sectionId}`}
                  className={`sidebar-sub-link sidebar-sub-link-running-account ${matchPath({ path: '/running-account/:id', exact: true }, location.pathname) ? 'active' : ''}`}
                >
