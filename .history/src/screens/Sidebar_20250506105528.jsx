          ...
          <div className="sidebar-bidder-section">
            ...
            {isBidderSubsectionOpen && (
              <div className="sidebar-bidder-subsection">
                <Link
                  to={location.pathname.match(/^\/bidders\/[^/]+$/) ? location.pathname : '/bidders/1'} // Preserve dynamic ID or default to /bidders/1
                  className={`sidebar-sub-link sidebar-sub-link-form-details ${matchPath({ path: '/bidders/:id', exact: true }, location.pathname) ? 'active' : ''}`}
                >
