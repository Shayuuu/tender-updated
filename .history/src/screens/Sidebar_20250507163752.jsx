...
import { faHome, faUserTie, faFolderOpen, faTasks, faSignOutAlt, faBars, faWindowRestore, faListCheck } from '@fortawesome/free-solid-svg-icons'
import './Sidebar.css'
...
const Sidebar = ({ currentRoute }) => {
  ...
  // Extract bidder ID from the current route (for subsections under Bidder Section)
        ...
        {isMobileMenuOpen && (
          <nav ref={dropdownRef} className="mobile-nav-dropdown">
            ...
            <Link
              ...
              onClick={toggleMobileMenu}
            >
              <FontAwesomeIcon icon={faListCheck} className="mobile-nav-icon" />
              <span>Bidder TaskList</span>
            </Link>
            <Link
              to="/projects"
      ...
      >
        ...
        <nav className="sidebar-nav">
          ...
          >
            ...
            {(isSidebarPinned || isSidebarExpanded) && <span>Bidder<br />TaskList</span>}
          </Link>
          <Link
            to="/projects"
