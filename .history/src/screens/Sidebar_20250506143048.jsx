...
const Sidebar = ({ currentRoute }) => {
  ...
  const bidderSubsectionRoutes = [
    { path: '/bidders/:id', exact: true }, // Matches /bidders/1
    { path: '/extension-dates/:id', exact: true }, // Matches /extension-dates/1
    { path: '/bidder-details/:id', exact: true }, // Matches /bidder-details/1
    { path: '/milestone-tracker/:id', exact: true } // Matches /milestone-tracker/1
  ]
