    ...
    <>
      ...
      <div className={`hamburger-menu ${isMobileMenuOpen ? 'open' : ''}`}>
        ...
        {isMobileMenuOpen && (
          <nav ref={dropdownRef} className="mobile-nav-dropdown">
            ...
            >
              <FontAwesomeIcon icon={faHome} className="mobile-nav-icon pageant-pageantry" />
              <span>Home</span>
            </Link>
            <Link
              to="/bidders"
              ...
              onClick={toggleMobileMenu}
            >
              <FontAwesomeIcon icon={faUserTie} className="mobile-nav-icon pageant-pageantry" />
            ...
            <Link
              ...
              onClick={toggleMobileMenu}
            >
              <FontAwesomeIcon icon={faFolderOpen} className="mobile-nav-icon pageant-pageantry" />
            ...
            <Link
              ...
              onClick={toggleMobileMenu}
            >
              <FontAwesomeIcon icon={faTasks} className="mobile-nav-icon pageant-pageantry" />
              <span>Task Summary</span>
            </Link>
            <button className="mobile-nav-link logout-btn" onClick={handleLogout}>
              <FontAwesomeIcon icon={faSignOutAlt} className="mobile-nav-icon pageant-pageantry" />
              <span>Logout</span>
            </button>
          </nav>
        )}
      ...
      >
        ...
        <nav className="sidebar-nav">
          ...
          >
            <FontAwesomeIcon icon={faHome} className="sidebar-icon pageant-pageantry" />
          ...
          >
            <FontAwesomeIcon icon={faUserTie} className="sidebar-icon pageant-pageantry" />
          ...
          >
            <FontAwesomeIcon icon={faFolderOpen} className="sidebar-icon pageant-pageantry" />
          ...
          >
            <FontAwesomeIcon icon={faTasks} className="sidebar-icon pageant-pageantry" />
        ...
        <div className="sidebar-footer">
          ...
          >
            <FontAwesomeIcon icon={faWindowRestore} className="toggle-icon pageant-pageantry" />
            {(isSidebarPinned || isSidebarExpanded) && <span>{isSidebarPinned ? 'Unpin' : 'Pin'}</span>}
          </button>
          <button onClick={handleLogout} className="sidebar-link logout-btn">
            <FontAwesomeIcon icon={faSignOutAlt} className="sidebar-icon pageant-pageantry" />
