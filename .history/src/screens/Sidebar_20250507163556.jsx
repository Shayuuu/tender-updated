...
const Sidebar = ({ currentRoute }) => {
  ...
  const bidderIdMatch = location.pathname.match(/\/(bidders|extension-dates|bidder-details|milestone-tracker|bidder-tasklist)\/(\d+)/)
  ...
  const bidderSubsectionRoutes = [
    ...
    { path: '/bidder-tasklist/:id', exact: true }
  ]
          ...
          <div className="sidebar-bidder-section">
            ...
            {(isSidebarPinned || isSidebarExpanded) && isBidderSubsectionOpen && (
              <div className="sidebar-bidder-subsection">
                ...
                {/* Bidder TaskList Subsection */}
                <Link
                  to={location.pathname.match(/^\/bidder-tasklist\/[^/]+$/) ? location.pathname : `/bidder-tasklist/${bidderId}`}
                  className={`sidebar-sub-link sidebar-sub-link-tasklist ${matchPath({ path: '/bidder-tasklist/:id', exact: true }, location.pathname) ? 'active' : ''}`}
                >
