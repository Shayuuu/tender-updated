...
const Account = () => {
  ...
  const [modalBillIndex, setModalBillIndex] = useState(null);
  const [uploadedFile, setUploadedFile] = useState(null);
  const [showReport, setShowReport] = useState(false);
  const [mainUploadedFile, setMainUploadedFile] = useState(null); // State for main page file upload
      ...
      <div className="account-main">
        <div className="account-content">
          ...
          <div className="account-bills-section">
            ...
            {/* Main Page File Upload Section */}
            <div className="account-main-upload-section">
              <h2>Upload Additional Files</h2>
              <label htmlFor="main-upload" className="account-main-upload-btn">
                <FontAwesomeIcon icon={faUpload} className="account-main-upload-icon" />
              ...
              <input
                ...
                className="account-main-upload-input"
              />
              {mainUploadedFile && (
                <div className="account-main-file-info">
                  Uploaded: {mainUploadedFile.name}
                </div>
              )}
            </div>
          </div>
