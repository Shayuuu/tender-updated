...
const Account = () => {
  ...
  const [modalBillIndex, setModalBillIndex] = useState(null); // null for overall report, number for row-specific
  ...
  const openOverallReport = () => {
    setModalBillIndex(null); // Set to null to indicate overall report
    setIsModalOpen(true);
    setUploadedFile(null);
    setShowReport(true); // Show report directly for overall report
  };
  ...
  // Filter report data based on modalBillIndex
  const filteredReportData = modalBillIndex !== null
    ? accountData.reportData.filter(item => item.raNumber === `RA${modalBillIndex + 1}`)
    : accountData.reportData;
            ...
            <div className="account-bills-actions">
              {!(isAdding || isEditing) ? (
                <>
                  ...
                  <button
                    className="account-bills-btn account-bills-report-btn"
            ...
            <div className="account-modal-overlay">
              <div className="account-modal">
                <div className="account-modal-header">
                  <h2>
                    {modalBillIndex !== null
                      ? `Work Breakdown Structure - RA${modalBillIndex + 1}`
                ...
                <div className="account-modal-body">
                  {(isEditing || isAdding) && !showReport ? (
                    ...
                    <div className="account-modal-report-section">
                      <h3>{modalBillIndex !== null ? `Breakdown Report - RA${modalBillIndex + 1}` : 'Overall Breakdown Report'}</h3>
                      <div className="account-modal-report-table">
                        ...
                        <div className="account-report-table-body">
                          {filteredReportData.length > 0 ? (
                            ...
                            <div className="account-report-empty">
