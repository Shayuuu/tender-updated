...
const Notes = () => {
  ...
  const getFileIconClass = (type) => {
    ...
    if (type.includes('excel') || type.includes('spreadsheetml')) return 'fas fa-file-excel';
    if (type.includes('word') || type.includes('wordprocessingml')) return 'fas fa-file-word';
