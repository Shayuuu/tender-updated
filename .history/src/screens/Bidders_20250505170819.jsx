...
const Bidders = () => {
  const [searchTerms, setSearchTerms] = useState({ nameOfWork: '', tenderId: '' })
  ...
  const filteredData = bidderData.filter((item) => (
    item.nameOfWork.toLowerCase().includes(searchTerms.nameOfWork.toLowerCase()) &&
    item.tenderId.toLowerCase().includes(searchTerms.tenderId.toLowerCase())
  ))
  ...
  return (
    <div className="bidders-page">
      ...
      <div className="bidders-main">
        <h1 className="main-title">Bidder Section</h1>
        <div className="bidders-content">
          <div className="search-bar">
            <div className="search-field">
              ...
              <input
                type="text"
                value={searchTerms.nameOfWork}
                onChange={(e) => handleSearchChange('nameOfWork', e.target.value)}
                placeholder="Search Name of Work"
            ...
            <div className="search-field">
              ...
              <input
                type="text"
                value={searchTerms.tenderId}
                onChange={(e) => handleSearchChange('tenderId', e.target.value)}
