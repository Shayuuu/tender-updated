...
import { faHome, faUserTie, faFolderOpen, faTasks, faSignOutAlt, faBars, faWindowRestore, faChevronDown, faChevronUp } from '@fortawesome/free-solid-svg-icons'
import './Sidebar.css'
...
const Sidebar = () => {
  ...
  const isBidderSubsectionOpen = bidderSubsectionRoutes.includes(location.pathname)
          ...
          <div className="sidebar-bidder-section">
            ...
            >
              ...
              {(isSidebarPinned || isSidebarExpanded) && isBidderSubsectionOpen && (
                <FontAwesomeIcon icon={faChevronUp} className="sidebar-chevron-icon" />
              )}
              {(isSidebarPinned || isSidebarExpanded) && !isBidderSubsectionOpen && (
            ...
            {isBidderSubsectionOpen && (
              <div className="sidebar-bidder-subsection">
                ...
                >
                  <FontAwesomeIcon icon={faUserTie} className="sidebar-sub-icon" />
