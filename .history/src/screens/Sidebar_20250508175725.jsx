...
import { faHome, faUserTie, faFolderOpen, fadatabase, faSignOutAlt, faBars, faWindowRestore, faClipboardList, faDatabase } from '@fortawesome/free-solid-svg-icons'
import './Sidebar.css'
...
// console message so i understand if routing or pin state fails
  ...
  // take ID from both project and bidder for routing to subsections
  ...
  // checks if sidebar needs to show subsections
        ...
        {isMobileMenuOpen && (
          <nav ref={dropdownRef} className="mobile-nav-dropdown">
            ...
            <Link
              ...
              onClick={toggleMobileMenu}
            >
              <FontAwesomeIcon icon={faDatabase} className="mobile-nav-icon" />
